  ...
  switch ($_GET[act]) {
    ...
    case "tambahpenyakit":
      echo "<form name=text_form method=POST action='$aksi?module=penyakit&act=input' onsubmit='return Blank_TextField_Validator()' enctype='multipart/form-data'>
          <br><br><table class='table table-bordered'>
		  <tr><td width=120>Nama Kerusakan</td><td><input autocomplete='off' type=text placeholder='Masukkan kerusakan baru...' class='form-control' name='nama_penyakit' size=30></td></tr>
		  <tr><td width=120>Detail Kerusakan</td><td> <textarea rows='4' cols='50' class='form-control' name='det_penyakit'type=text placeholder='Masukkan detail kerusakan baru...'></textarea></td></tr>
		  <tr><td width=120>Saran Kerusakan</td><td><textarea rows='4' cols='50' class='form-control' name='srn_penyakit'type=text placeholder='Masukkan saran kerusakan baru...'></textarea></td></tr>
    ...
    case "editpenyakit":
      ...
      echo "<form name=text_form method=POST action='$aksi?module=penyakit&act=update' onsubmit='return Blank_TextField_Validator()' enctype='multipart/form-data'>
          ...
          <br><br><table class='table table-bordered'>
		  <tr><td width=120>Nama Kerusakan</td><td><input autocomplete='off' type=text class='form-control' name='nama_penyakit' size=30 value=\"$r[nama_penyakit]\"></td></tr>
		  <tr><td width=120>Detail Kerusakan</td><td><textarea rows='4' cols='50' type=text class='form-control' name='det_penyakit'>$r[det_penyakit]</textarea></td></tr>
		  <tr><td width=120>Saran Kerusakan</td><td><textarea rows='4' cols='50' type=text class='form-control' name='srn_penyakit'>$r[srn_penyakit]</textarea></td></tr>
