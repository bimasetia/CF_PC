<title>Diagnosa Komputer - Certainty Factor </title>
<?php
switch ($_GET['act']) {
...
// --------------------- END -------------------------
	...
	<h2 class='text text-primary'>Hasil Diagnosis &nbsp;&nbsp;<button id='print' onClick='window.print();' data-toggle='tooltip' data-placement='right' title='Klik tombol ini untuk mencetak hasil diagnosa'><i class='fa fa-print'></i> Cetak</button> </h2>
      ...
      echo "<div class='callout callout-default'>Jenis kerusakan yang terkena adalah <b><h3 class='text text-success'>" . $nmpkt[1] . "</b> / " . round($vlpkt[1], 2) . "  (" . $vlpkt[1] . ")<br></h3>";
	 ...
	 <div class='alert alert-success alert-dismissible'>
                ...
                Silahkan memilih gejala sesuai dengan kondisi komputer anda, dapat memilih kepastian kondisi komputer dari tidak pasti sampai pasti, jika sudah tekan tombol proses (<i class='fa fa-search-plus'></i>)  di bawah untuk melihat hasil.
              </div>
