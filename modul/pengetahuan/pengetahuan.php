<title>Basis Pengetahuan - Diagnosis Komputer</title>
<?php
...
switch($_GET[act]){
  ...
  case "tambahpengetahuan":
	echo "	<div class='alert alert-success alert-dismissible'>
                ...
                Silahkan pilih gejala yang sesuai dengan kerusakan yang ada, dan berikan <b>nilai kepastian (MB & MD)</b> dengan cakupan sebagai berikut:<br><br>
				...
				<b>Contoh:</b><br>
				Jika kepercayaan <b>(MB)</b> anda terhadap gejala Virus untuk kerusakan Cpu sering hang adalah <b>0.8 (Hampir Pasti)</b><br>
				Dan ketidakpercayaan <b>(MD)</b> anda terhadap gejala Virus untuk kerusakan Cpu sering hang adalah <b>0.2 (Hampir Mungkin)</b><br><br>
				<b>Maka:</b> CF(Pakar) = MB – MD (0.8 - 0.2) = <b>0.6</b> <br>
				Dimana nilai kepastian anda terhadap gejala Virus untuk kerusakan Cpu sering hang adalah <b>0.6 (Kemungkinan Besar)</b>
              </div>
          <form name=text_form method=POST action='$aksi?module=pengetahuan&act=input' onsubmit='return Blank_TextField_Validator()'>
          <br><br><table class='table table-bordered'>
		  <tr><td width=120>Kerusakan</td><td><select class='form-control' name='kode_penyakit'  id='kode_penyakit'><option value=''>- Pilih Kerusakan -</option>";
  ...
  case "editpengetahuan":
	...
	<form name=text_form method=POST action='$aksi?module=pengetahuan&act=update' onsubmit='return Blank_TextField_Validator()'>
          ...
          <br><br><table class='table table-bordered'>
		  <tr><td width=120>Kerusakan</td><td><select class='form-control' name='kode_penyakit' id='kode_penyakit'>";
		$hasil4 = mysql_query("SELECT * FROM penyakit order by nama_penyakit");
		while($r4=mysql_fetch_array($hasil4)){
